...
use crate::services::create_surface::create_surface_c0;

pub struct CreateSurfaceC0 {
    pub id: u64,
...
impl Command<CreateSurfaceC0> for CreateSurfaceC0 {
    fn execute(command: &CreateSurfaceC0, app_state: Rc<RefCell<Backend>>) {
        ...
        let (surface, points) = create_surface_c0(
            command.id,
        ...
        backend
            .services
            .event_publisher
            .publish(Rc::new(SurfaceC0Created::new(
                command.id,
