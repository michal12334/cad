...
pub struct DeleteBezierC0PointOnBezierC0PointsDeleted {
    pub drawing_storage: Rc<RefCell<DrawingStorage>>,
    pub cqrs: CQRS,
    pub display: Rc<Display<WindowSurface>>
}

impl Consumer<BezierC0PointsDeleted> for DeleteBezierC0PointOnBezierC0PointsDeleted {
...
impl AnyConsumer for DeleteBezierC0PointOnBezierC0PointsDeleted {
