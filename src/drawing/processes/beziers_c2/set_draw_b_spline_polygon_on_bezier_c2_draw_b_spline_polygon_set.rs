...
use std::rc::Rc;
use backend_events::bezier_c2_draw_b_spline_polygon_set::BezierC2DrawBSplinePolygonSet;
...
impl Consumer<BezierC2DrawBSplinePolygonSet> for SetDrawBSplinePolygonOnBezierC2DrawBSplinePolygonSet {
