...
use backend_events::beziers_c2::bezier_c2_draw_bernstein_polygon_set::BezierC2DrawBernsteinPolygonSet;
...
impl Consumer<BezierC2DrawBernsteinPolygonSet>
    for SetDrawBernsteinPolygonOnBezierC2DrawBernsteinPolygonSet
{
