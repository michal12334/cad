...
use backend_events::beziers_c2::bezier_c2_selected_bernstein_point_set::BezierC2SelectedBernsteinPointSet;
...
impl Consumer<BezierC2SelectedBernsteinPointSet>
    for SetSelectedBernsteinPointOnBezierC2SelectedBernsteinPointSet
{
